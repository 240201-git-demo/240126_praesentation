...
\begin{document}
    ...
    \begin{frame}
        ...
        \only<2>{\includegraphics[height=7cm]{images/create_repository.png}}
        \only<4>{\includegraphics{images/code_button.png}}
        \only<6>{\includegraphics[height=7cm]{images/vsc_view_terminal.png}}      
    ...
    \begin{frame}
        ...
        \only<2>{\includegraphics[height=5cm]{images/vsc_commit_window.png}}
        \only<3>{\includegraphics[height=5cm]{images/vsc_commit_message.png}}
        \only<5>{\includegraphics[height=5cm]{images/vsc_push.png}}   
    ...
    \begin{frame}
        ...
        \only<2>{\includegraphics[width=3cm]{images/vsc_branch_indicator.png}}
        \only<3>{\includegraphics[width=7cm]{images/vsc_branch_auswahl.png}}
        \only<4>{\includegraphics[width=7cm]{images/vsc_branch_voila.png}}
        \only<6>{\includegraphics[width=5cm]{images/vsc_pr_button.png}}
        \only<7>{\includegraphics[height=5cm]{images/vsc_pr_dialog.png}}
        \only<8>{\includegraphics[width=7cm]{images/vsc_merge_dialog.png}}
        \only<9>{\includegraphics[width=5cm]{images/vsc_git_graph_merged.png}}
